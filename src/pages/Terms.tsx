    ...
    >
      <article className="px-4 py-16 md:py-24 text-slate-700">
        <div className="container mx-auto max-w-3xl space-y-6">
          <h1 className="text-3xl font-semibold text-slate-900">ABOH Studio — Terms of Use</h1>
          ...
          <p className="font-semibold text-slate-900">1. About Us</p>
          <p>ABOH Studio</p>
          ...
          <p className="font-semibold text-slate-900">2. Purpose of the Website</p>
          <p>
          ...
          <p className="font-semibold text-slate-900">3. Contact Form &amp; User Submissions</p>
          ...
          <p className="font-semibold text-slate-900">4. Intellectual Property</p>
          ...
          <p className="font-semibold text-slate-900">5. Open-Source &amp; Third-Party Components</p>
          ...
          <p className="font-semibold text-slate-900">6. Acceptable Use</p>
          ...
          <p className="font-semibold text-slate-900">7. Third-Party Services</p>
          ...
          <p className="font-semibold text-slate-900">8. Disclaimer of Warranties</p>
          ...
          <p className="font-semibold text-slate-900">9. Limitation of Liability</p>
          ...
          <p className="font-semibold text-slate-900">10. Cookies &amp; Analytics</p>
          ...
          <p className="font-semibold text-slate-900">11. Links to Other Websites</p>
          ...
          <p className="font-semibold text-slate-900">12. Modifications to the Website</p>
          ...
          <p className="font-semibold text-slate-900">13. Changes to These Terms</p>
          ...
          <p className="font-semibold text-slate-900">14. Governing Law &amp; Jurisdiction</p>
          ...
          <p className="font-semibold text-slate-900">15. Contact Information</p>
