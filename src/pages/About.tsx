...
const About = () => {
  const structuredData = {
    ...
    "@type": "AboutPage",
    "name": "About ABOH - AI Innovation Studio",
    "description": "Learn about ABOH's mission to fuse elegant design with real AI impact"
  };

  return (
    <Layout 
      title="About Us"
      description="ABOH fuses elegant design with real AI impact. Founded by engineers and strategists from leading AI labs, we help organizations translate AI hype into measurable outcomes."
      keywords="about ABOH, AI innovation, AI company, machine learning experts, AI team"
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid gap-12 md:grid-cols-2">
            ...
            <div className="animate-slide-up" style={{ animationDelay: "100ms" }}>
              <h2 className="mb-6 text-white">Values we live by</h2>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <h2 className="mb-6 text-white">Strategy, prototyping, release—without the silos.</h2>
              <p className="text-lg text-gray-300 leading-relaxed">
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-soft transition-smooth hover:shadow-medium hover:-translate-y-1">
                <p className="font-semibold text-white">Human-centered research</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-soft transition-smooth hover:shadow-medium hover:-translate-y-1">
                <p className="font-semibold text-white">Responsible AI playbooks</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm p-6 shadow-soft transition-smooth hover:shadow-medium hover:-translate-y-1">
                <p className="font-semibold text-white">Lifecycle partnerships</p>
              </div>
            </div>
          </div>
        </div>
