    ...
    >
      <article className="px-4 py-16 md:py-24">
        <div className="container mx-auto max-w-3xl space-y-6 text-slate-900">
          <h1 className="text-3xl font-semibold">ABOH Studio — Privacy Policy</h1>
          ...
          <p className="font-semibold">1. Data Controller</p>
          ...
          <p className="font-semibold">2. Personal Data We Collect</p>
          ...
          <p className="font-semibold">2.2 Data Collected Automatically (Analytics &amp; Technical Data)</p>
          ...
          <p className="font-semibold">3. How We Use Your Personal Data</p>
          ...
          <p className="font-semibold">Improving the Website and services</p>
          <p>To analyse how visitors use the Website so we can improve content, layout, and performance.</p>
          <p className="font-semibold">Understanding interest in our services</p>
          ...
          <p className="font-semibold">Security and abuse prevention</p>
          ...
          <p className="font-semibold">Future marketing communications (if and when used)</p>
          ...
          <p className="font-semibold">4. Legal Bases for Processing</p>
          ...
          <p className="font-semibold">5. How We Store and Process Your Data</p>
          <p className="font-semibold">5.1 Contact Form Processing</p>
          ...
          <p className="font-semibold">5.2 Data Retention</p>
          ...
          <p className="font-semibold">6. Data Sharing and Third Parties</p>
          <p>We do not sell or rent your personal data.</p>
          <p>We may share your personal data only with:</p>
          <p className="font-semibold">Service providers / processors, including:</p>
          ...
          <p className="font-semibold">Professional advisers, where necessary:</p>
          <p>Such as legal or accounting professionals, subject to confidentiality obligations.</p>
          <p className="font-semibold">Authorities or regulators, where required by law:</p>
          ...
          <p className="font-semibold">7. Cookies and Analytics</p>
          ...
          <p className="font-semibold">8. International Data Transfers</p>
          ...
          <p className="font-semibold">10. Children’s Data</p>
          ...
          <p className="font-semibold">11. Security</p>
          ...
          <p className="font-semibold">12. Changes to This Privacy Policy</p>
          ...
          <p className="font-semibold">13. Contact Us</p>
